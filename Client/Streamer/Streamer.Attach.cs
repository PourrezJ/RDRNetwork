...
namespace RDRNetwork
{
    ...
    {
        internal static void AttachEntityToEntity(IStreamedItem ent, IStreamedItem entTarget, Attachment info)
        {
        ...
        internal static void DetachEntity(IStreamedItem ent, bool collision)
        {
        ...
        internal static void ReattachAllEntities(IStreamedItem ent, bool recursive)
        {
