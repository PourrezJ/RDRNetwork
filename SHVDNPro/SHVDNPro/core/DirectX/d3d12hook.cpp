...
namespace d3d12hook {
	...
	{
		alt::Log::Info << "Dx12 Hook Initialization..." << alt::Log::Endl;
		if (kiero::init(kiero::RenderType::D3D12) == kiero::Status::Success) {
			alt::Log::Info << "Dx12 Hook hookExecuteCommandListsD3D12" << alt::Log::Endl;
			if (kiero::bind(54, (void**)&d3d12hook::oExecuteCommandListsD3D12, d3d12hook::hookExecuteCommandListsD3D12) != kiero::Status::Success)
				return;
			alt::Log::Info << "Dx12 Hook hookSignalD3D12" << alt::Log::Endl;
			if (kiero::bind(58, (void**)&d3d12hook::oSignalD3D12, d3d12hook::hookSignalD3D12) != kiero::Status::Success)
				return;
			alt::Log::Info << "Dx12 Hook hookPresentD3D12" << alt::Log::Endl;
			if (kiero::bind(140, (void**)&d3d12hook::oPresentD3D12, d3d12hook::hookPresentD3D12) != kiero::Status::Success)
				return;
			alt::Log::Info << "Dx12 Hook hookkDrawInstancedD3D12" << alt::Log::Endl;
			if (kiero::bind(84, (void**)&d3d12hook::oDrawInstancedD3D12, d3d12hook::hookkDrawInstancedD3D12) != kiero::Status::Success)
				return;
			alt::Log::Info << "Dx12 Hook hookDrawIndexedInstancedD3D12" << alt::Log::Endl;
			if (kiero::bind(85, (void**)&d3d12hook::oDrawIndexedInstancedD3D12, d3d12hook::hookDrawIndexedInstancedD3D12) != kiero::Status::Success)
				return;

			alt::Log::Info << "Dx12 Hook Success!" << alt::Log::Endl;
		}
	}
