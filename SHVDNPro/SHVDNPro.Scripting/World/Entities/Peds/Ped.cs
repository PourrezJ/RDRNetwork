...
namespace RDR2
{
	...
	public sealed class Ped : Entity
	{
		...
		/// <summary>
		/// Opens a list of <see cref="RDR2.NaturalMotion.Euphoria"/> Helpers which can be applied to this <see cref="Ped"/>.
		/// </summary>
		...
		public RelationshipGroup RelationshipGroup
		{
			get
			{
				return new RDR2.RelationshipGroup(Function.Call<int>(Hash.GET_PED_RELATIONSHIP_GROUP_HASH, Handle));
			}
			set
			{
