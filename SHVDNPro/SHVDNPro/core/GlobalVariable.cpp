...
RDR2::Native::GlobalVariable RDR2::Native::GlobalVariable::Get(int index)
{
...
RDR2::Native::GlobalVariable::GlobalVariable(System::IntPtr address) : _address(address)
{
}

generic <typename T> T RDR2::Native::GlobalVariable::Read()
{
...
generic <typename T> void RDR2::Native::GlobalVariable::Write(T value)
{
	if (T::typeid == System::String::typeid) {
...
void RDR2::Native::GlobalVariable::WriteString(System::String^ value, int maxSize)
{
...
void RDR2::Native::GlobalVariable::SetBit(int index)
{
	if (index < 0 || index > 63) {
...
void RDR2::Native::GlobalVariable::ClearBit(int index)
{
	if (index < 0 || index > 63) {
		throw gcnew System::IndexOutOfRangeException("The bit index has to be between 0 and 63");
	}
...
bool RDR2::Native::GlobalVariable::IsBitSet(int index)
{
	if (index < 0 || index > 63) {
		throw gcnew System::IndexOutOfRangeException("The bit index has to be between 0 and 63");
	}
...
RDR2::Native::GlobalVariable RDR2::Native::GlobalVariable::GetStructField(int index)
{
	if (index < 0) {
...
array<RDR2::Native::GlobalVariable>^ RDR2::Native::GlobalVariable::GetArray(int itemSize)
{
	if (itemSize <= 0) {
...
RDR2::Native::GlobalVariable RDR2::Native::GlobalVariable::GetArrayItem(int index, int itemSize)
{
	if (itemSize <= 0) {
		throw gcnew System::ArgumentOutOfRangeException("itemSize", "The item size for an array must be positive.");
	}
