...
namespace RDRNetwork.API
{
	public class Tasks
	{
		...
		{
			Function.Call(Hash.TASK_VEHICLE_DRIVE_TO_COORD, _ped.Handle, vehicle.Handle, position.X, position.Y, position.Z, speed, Function.Call<int>(Hash.GET_HASH_KEY, vehicle.Handle), drivingstyle, radius, false);
		}
