...
namespace RDR2
{
	...
	public class EntityParticleEffect : ParticleEffect
	{
		...
		/// <summary>
		/// Gets or sets the <see cref="RDR2.Entity"/> this <see cref="EntityParticleEffect"/> is attached to.
		/// </summary>
		...
		/// <summary>
		/// Creates a copy of this <see cref="EntityParticleEffect"/> to another <see cref="RDR2.Entity"/> to simplify applying the same effect to many Entities.
		/// </summary>
		/// <param name="entity">The <see cref="RDR2.Entity"/> to copy to.</param>
		/// <returns>An <see cref="EntityParticleEffect"/> that has all the same properties as this instance, but for a different <see cref="RDR2.Entity"/>.</returns>
		...
		/// <summary>
		/// Creates a copy of this <see cref="EntityParticleEffect"/> to another <see cref="RDR2.EntityBone"/> to simplify applying the same effect to many Entities.
		/// </summary>
		/// <param name="entityBone">The <see cref="RDR2.EntityBone"/> to copy to.</param>
		/// <returns>An <see cref="EntityParticleEffect"/> that has all the same properties as this instance, but for a different <see cref="RDR2.EntityBone"/>.</returns>
