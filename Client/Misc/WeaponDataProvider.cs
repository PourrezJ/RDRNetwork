...
{
    internal static class WeaponDataProvider
    {
        public static bool IsWeaponAutomatic(RDRNetworkShared.WeaponHash hash)
        {
            switch (hash)
            {
                default:
                    return true;
                    /*
                case RDRNetworkShared.WeaponHash.Molotov:
                case RDRNetworkShared.WeaponHash.BZGas:
                case RDRNetworkShared.WeaponHash.SmokeGrenade:
                case RDRNetworkShared.WeaponHash.ProximityMine:
                case RDRNetworkShared.WeaponHash.StickyBomb:
                case RDRNetworkShared.WeaponHash.Grenade:
                case RDRNetworkShared.WeaponHash.Flare:
                case RDRNetworkShared.WeaponHash.Snowball:
                case RDRNetworkShared.WeaponHash.Ball:
                case RDRNetworkShared.WeaponHash.Pipebomb:

                case RDRNetworkShared.WeaponHash.RPG:
                case RDRNetworkShared.WeaponHash.HomingLauncher:
                case RDRNetworkShared.WeaponHash.Railgun:
                case RDRNetworkShared.WeaponHash.GrenadeLauncher:
                case RDRNetworkShared.WeaponHash.Firework:
                case RDRNetworkShared.WeaponHash.Musket:
                case RDRNetworkShared.WeaponHash.FlareGun:
                case RDRNetworkShared.WeaponHash.CompactLauncher:
        ...
        public static bool NeedsFakeBullets(int wephash)
        {
            ...
            switch ((RDRNetworkShared.WeaponHash)uW)
            {
                default:
                    return false;
                /*case RDRNetworkShared.WeaponHash.Molotov:
