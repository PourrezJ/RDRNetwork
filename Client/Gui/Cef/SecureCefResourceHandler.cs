...
namespace RDRNetwork.Gui.Cef
{
    ...
    {
        internal const string DefaultMimeType = "text/html";
        ...
        internal bool AutoDisposeStream { get; set; }
        internal CefErrorCode? ErrorCode { get; set; }

        internal SecureCefResourceHandler() : this(DefaultMimeType)
        { }

        internal SecureCefResourceHandler(string mimeType)
        {
        ...
        internal static SecureCefResourceHandler FromFilePath(string fileName, string mimeType = null)
        {
        ...
        internal static SecureCefResourceHandler FromString(string text, string fileExtension)
        {
            var mimeType = Cef.MimeType.GetMimeType(fileExtension);
            return FromString(text, Encoding.UTF8, false, mimeType);
        }

        internal static SecureCefResourceHandler FromString(string text, Encoding encoding = null,
        ...
        internal static SecureCefResourceHandler FromStream(Stream stream, string mimeType = DefaultMimeType)
        {
        ...
        protected override bool Read(IntPtr response, int bytesToRead, out int bytesRead, CefResourceReadCallback callback)
        {
            callback.Dispose();
            bytesRead = -1;
            return false;
