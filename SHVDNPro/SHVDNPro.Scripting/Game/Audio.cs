...
namespace RDR2
{
	...
	public static class Audio
	{
		...
		{
			Function.Call(Hash._PLAY_SOUND_FROM_ENTITY, -1, soundFile, entity.Handle, 0, 0, 0);
		...
		{
			Function.Call(Hash._PLAY_SOUND_FROM_ENTITY, -1, soundFile, entity.Handle, soundSet, 0, 0);
			return Function.Call<int>(Hash.GET_SOUND_ID);
		}
		/// <summary>
		...
		{
			Function.Call(Hash._PLAY_SOUND_FROM_POSITION, -1, soundFile, position.X, position.Y, position.Z, 0, 0, 0, 0);
			return Function.Call<int>(Hash.GET_SOUND_ID);
		}
		/// <summary>
		/// Plays a sound from the game's sound files at the specified <paramref name="position"/>.
		...
		{
			Function.Call(Hash._PLAY_SOUND_FROM_POSITION, -1, soundFile, position.X, position.Y, position.Z, soundSet, 0, 0, 0);
			return Function.Call<int>(Hash.GET_SOUND_ID);
		}
		/// <summary>
